...
export function constructMetadata({
  title = "Datavault | The Open Source DocSend Alternative",
  description = "Datavault is an open-source document sharing alternative to DocSend with built-in engagement analytics and 100% white-labeling.",
  image = "https://www.datavault.com/_static/meta-image.png",
  favicon = "/favicon.ico",
  noIndex = false,
}: {
  title?: string;
