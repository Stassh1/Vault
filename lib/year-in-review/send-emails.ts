...
import YearInReviewEmail from "@/components/emails/year-in-review-datavault";
            ...
            return Promise.all(
              team!.users
                ...
                .map(async (userTeam) => {
                  ...
                  return {
                    email: {
                      from: "Datavault <system@datavault.io>",
                      to: userTeam.user.email || "delivered@resend.dev",
                      subject: "2024 in Review: Your Year with Datavault",
                      react,
                      text: plainText,
                      headers: {
