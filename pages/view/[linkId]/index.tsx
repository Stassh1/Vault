      ...
      return {
        props: {
          ...
          meta: {
            ...
            metaUrl: `https://www.datavault.com/view/${linkId}`,
          },
...
export default function ViewPage({
  ...
  useEffect(() => {
    ...
    const storedEmail = window.localStorage.getItem("datavault.email");
    if (cookieToken) {
      ...
      return (
        <>
          <CustomMetaTag
            ...
            title={
              meta.metaTitle ?? `${link?.document?.name} | Powered by Datavault`
            }
      ...
      return (
        <>
          <CustomMetaTag
            ...
            enableBranding={meta.enableCustomMetatag ?? false}
            title={
              meta.metaTitle ?? `${link?.dataroom?.name} | Powered by Datavault`
            }
            description={meta.metaDescription ?? null}
            imageUrl={meta.metaImage ?? null}
            url={meta.metaUrl ?? ""}
